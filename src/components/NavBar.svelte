...
<div class="bg-base-100 mt-2 py-4 px-2 sm:px-8 border-neutral flex flex-wrap w-full justify-center gap-4 md:gap-8" >
    <div class=" lg:m-0">
        <div class="flex flex-wrap space-x-2 items-center justify-center {precise ? "lg" : "md"}:justify-end">
